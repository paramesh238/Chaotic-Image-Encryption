...
main = tkinter.Tk()
main.title("A Novel Chaotic Image Encryption Algorithm Based on Coordinate Descent and SHA-256") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='A Novel Chaotic Image Encryption Algorithm Based on Coordinate Descent and SHA-256', justify=LEFT)
